...
public partial class GameScript : GameScriptInterfaceExtended
{
    ...
    {
        /// <summary>
        /// Sets the slow-motion modifier. Equivalent to the <c>settime</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Enables or disables slow-motion. Equivalent to the <c>slomo</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Enables or disables infinite ammo. Equivalent to the <c>infinite_ammo</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Enables or disables infinite life. Equivalent to the <c>infinite_life</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Enables or disables infinite energy. Equivalent to the <c>infinite_energy</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the starting life for players. Equivalent to the <c>startlife</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the starting weapon items for players. Equivalent to the <c>setstartitems</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Resets all active cheats. Equivalent to the <c>clear</c> console command.
        /// </summary>
        public static void Clear() => Game.RunCommand("clear");

        /// <summary>
        /// Restarts the current fight immediately. Equivalent to the <c>rs</c> (restart) console command.
        /// </summary>
        public static void Restart() => Game.RunCommand("rs");

        /// <summary>
        /// Advances to the next map in the rotation. Equivalent to the <c>nextmap</c> console command.
        /// </summary>
        public static void NextMap() => Game.RunCommand("nextmap");

        /// <summary>
        /// Changes the map category. Equivalent to the <c>changemapcategory</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Changes the map for the next fight. Equivalent to the <c>changemap</c> console command.
        /// </summary>
        /// <param name="map">The name of the map to load.</param>
        public static void ChangeMap(string map) => Game.RunCommand($"changemap {map}");

        /// <summary>
        /// Starts a script by name. Equivalent to the <c>startscript</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Stops a script by name. Equivalent to the <c>stopscript</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the current campaign chapter. Equivalent to the <c>setchapter</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Advances to the next campaign chapter. Equivalent to the <c>nextchapter</c> console command.
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown when the current map type is not <see cref="MapType.Campaign"/>.</exception>
        ...
        /// <summary>
        /// Sets the map rotation interval. Equivalent to the <c>maprotation</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the map rotation mode. Equivalent to the <c>maprotation</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the map rotation mode and interval. Equivalent to the <c>maprotation</c> console command.
        /// </summary>
        /// <param name="amount">The number of fights before rotation.</param>
        /// <param name="mode">The rotation mode (<see cref="MapRotationMode"/>).</param>
        ...
        /// <summary>
        /// Sets the difficulty for campaign maps. Equivalent to the <c>setdifficulty</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the round time limit. Equivalent to the <c>timelimit</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Shuffles the teams for the next fight. Equivalent to the <c>shuffleteams</c> console command.
        /// </summary>
        public static void ShuffleTeams() => Game.RunCommand("shuffleteams");

        /// <summary>
        /// Shuffles the teams every specified number of fights. Equivalent to the <c>shuffleteams</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Enables or disables global chat. Equivalent to the <c>chat</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Bans a player. Equivalent to the <c>ban</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Kicks a player. Equivalent to the <c>kick</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Kicks a player for a specified duration. Equivalent to the <c>kick</c> console command with a time parameter.
        /// </summary>
        /// <param name="player">The player to kick.</param>
        ...
        /// <summary>
        /// Sets the maximum allowed ping. Equivalent to the <c>maxping</c> console command.
        /// </summary>
        ...
        /// <summary>
        /// Sets the maximum idle time before a player is kicked. Equivalent to the <c>kickidle</c> console command.
        /// </summary>
